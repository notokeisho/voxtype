...
class LocalizationManager: ObservableObject {
    ...
    private static let englishTranslations: [String: String] = [
        ...
        "hotkey.recordingInputTitle": "Recording Input",
        "hotkey.recordingInputKeyboard": "Keyboard",
        "hotkey.recordingInputMouse": "Mouse Wheel Hold",
    ...
    private static let japaneseTranslations: [String: String] = [
        ...
        "hotkey.recordingInputTitle": "録音入力",
        "hotkey.recordingInputKeyboard": "キーボード",
        "hotkey.recordingInputMouse": "マウスホイール長押し",
