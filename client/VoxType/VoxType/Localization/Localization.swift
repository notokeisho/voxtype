...
class LocalizationManager: ObservableObject {
    ...
    private static let englishTranslations: [String: String] = [
        ...
        "hotkey.recordingMode": "Recording Mode",
        "hotkey.mode.keyboardHold": "Keyboard Hold",
        "hotkey.mode.rightShiftDoubleTap": "Right Shift Double Tap",
        "hotkey.mode.mouseWheelHold": "Mouse Wheel Hold",
        ...
        "hotkey.rightShiftHint": "Press the right Shift key twice to start/stop recording.",
        "hotkey.rightShiftTest": "Run Input Test",
        "hotkey.rightShiftTestInstruction": "Press the right Shift key once to verify detection.",
        "hotkey.rightShiftTestSuccess": "Input detection succeeded.",
        "hotkey.rightShiftTestFailed": "This key is not available in the current environment. Choose a different mode.",
        ...
        "dictionary.duplicatePattern": "Pattern already exists",
        ...
        "globalRequest.patternPlaceholder": "e.g., kuroad",
        "globalRequest.replacementPlaceholder": "e.g., Claude",
    ...
    private static let japaneseTranslations: [String: String] = [
        ...
        "hotkey.recordingMode": "録音方式",
        "hotkey.mode.keyboardHold": "キーボード長押し",
        "hotkey.mode.rightShiftDoubleTap": "右Shiftキーを2回",
        "hotkey.mode.mouseWheelHold": "マウスホイール長押し",
        "hotkey.mouseHoldEnabled": "マウスホイール長押しを有効",
        "hotkey.mouseHoldHint": "1秒以上押し続けると録音が開始されます。",
        "hotkey.rightShiftHint": "右Shiftキーを2回押すと録音の開始/停止を切り替えます。",
        "hotkey.rightShiftTest": "入力テストを実行",
        "hotkey.rightShiftTestInstruction": "右Shiftキーを1回押して検出できるか確認してください。",
        "hotkey.rightShiftTestSuccess": "入力を検出できました。",
        "hotkey.rightShiftTestFailed": "このキーは現在の環境で使用できません。別の方式を選択してください。",
        ...
        "dictionary.duplicatePattern": "同じパターンが既に登録されています",
