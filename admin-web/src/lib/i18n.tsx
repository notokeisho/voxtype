...
const translations = {
  ja: {
    ...
    'dictionary.backupTitle': '自動バックアップ',
    'dictionary.backupLastRun': '最新実行: {datetime}',
    'dictionary.backupNotRun': '最新実行: 未実行',
    'dictionary.backupRunNow': '今すぐバックアップ実行',
    'dictionary.backupRunning': 'バックアップ実行中...',
    'dictionary.backupConfirmTitle': 'バックアップ実行の確認',
    'dictionary.backupConfirmDescription': '今すぐバックアップを実行しますか？',
    'dictionary.backupConfirmRun': '実行',
    'dictionary.backupRunFailed': '手動バックアップの実行に失敗しました',
    'dictionary.backupManualLastRun': '最新手動実行: {datetime}',
    'dictionary.backupManualCreatedFile': '作成ファイル: {file}',
    'dictionary.backupManualSummary': '保持: {kept} / 削除: {deleted}',
    'dictionary.export': 'Excel(.xlsx) を出力',
    'dictionary.exporting': '出力中...',
    'dictionary.exportConfirmTitle': 'Excel出力の確認',
    'dictionary.exportConfirmDescription': 'グローバル辞書をExcelで出力しますか？',
    'dictionary.exportConfirmRun': '実行',
    'dictionary.backupFilesTitle': 'バックアップ一覧',
    'dictionary.backupFilesEmpty': 'バックアップファイルがありません',
    'dictionary.backupFilesFetchFailed': 'バックアップ一覧の取得に失敗しました',
    'dictionary.backupRestore': '復元',
    'dictionary.restoreConfirmTitle': 'バックアップ復元の確認',
    'dictionary.restoreConfirmDescription': '次のバックアップから復元しますか？\n{filename}',
    'dictionary.restoreConfirmDescriptionEmpty': '復元するバックアップを選択してください',
    'dictionary.restoreModeLabel': '復元モード',
    'dictionary.restoreModeMerge': 'merge（既存を残して追加）',
    'dictionary.restoreModeReplace': 'replace（既存を削除して置換）',
    'dictionary.restoreConfirmRun': '復元',
    'dictionary.restoreReplaceFinalTitle': 'replace実行の最終確認',
    'dictionary.restoreReplaceFinalConfirm': '既存のグローバル辞書を削除して復元します。本当に実行しますか？',
    'dictionary.restoreReplaceRun': 'replaceで復元',
    'dictionary.restoreRunning': '復元中...',
    'dictionary.restoreSuccess': 'バックアップを復元しました',
    'dictionary.restoreFile': '対象ファイル: {file}',
    'dictionary.restoreSummary': 'mode: {mode} / total: {total} / added: {added} / skipped: {skipped} / failed: {failed}',
    'dictionary.restoreLastRun': '実行日時: {datetime}',
    'dictionary.restoreFailed': 'バックアップの復元に失敗しました',
    'dictionary.import': 'Excel(.xlsx) を読み込む',
    ...
    'dictionary.backupFetchFailed': 'バックアップ設定の取得に失敗しました',
    'dictionary.backupUpdateFailed': 'バックアップ設定の更新に失敗しました',
  ...
  en: {
    ...
    'dictionary.backupTitle': 'Auto Backup',
    'dictionary.backupLastRun': 'Last run: {datetime}',
    'dictionary.backupNotRun': 'Last run: Not run yet',
    'dictionary.backupRunNow': 'Run backup now',
    'dictionary.backupRunning': 'Running backup...',
    'dictionary.backupConfirmTitle': 'Confirm backup run',
    'dictionary.backupConfirmDescription': 'Run backup now?',
    'dictionary.backupConfirmRun': 'Run',
    'dictionary.backupRunFailed': 'Failed to run manual backup',
    'dictionary.backupManualLastRun': 'Latest manual run: {datetime}',
    'dictionary.backupManualCreatedFile': 'Created file: {file}',
    'dictionary.backupManualSummary': 'Kept: {kept} / Deleted: {deleted}',
    'dictionary.export': 'Export Excel (.xlsx)',
    'dictionary.exporting': 'Exporting...',
    'dictionary.exportConfirmTitle': 'Confirm Excel export',
    'dictionary.exportConfirmDescription': 'Export global dictionary as Excel?',
    'dictionary.exportConfirmRun': 'Run',
    'dictionary.backupFilesTitle': 'Backup Files',
    'dictionary.backupFilesEmpty': 'No backup files',
    'dictionary.backupFilesFetchFailed': 'Failed to fetch backup files',
    'dictionary.backupRestore': 'Restore',
    'dictionary.restoreConfirmTitle': 'Confirm backup restore',
    'dictionary.restoreConfirmDescription': 'Restore from the following backup?\n{filename}',
    'dictionary.restoreConfirmDescriptionEmpty': 'Select a backup file to restore',
    'dictionary.restoreModeLabel': 'Restore mode',
    'dictionary.restoreModeMerge': 'merge (keep existing and append)',
    'dictionary.restoreModeReplace': 'replace (delete existing and restore)',
    'dictionary.restoreConfirmRun': 'Restore',
    'dictionary.restoreReplaceFinalTitle': 'Final confirmation for replace',
    'dictionary.restoreReplaceFinalConfirm': 'This will delete the current global dictionary and restore from backup. Continue?',
    'dictionary.restoreReplaceRun': 'Restore with replace',
    'dictionary.restoreRunning': 'Restoring...',
    'dictionary.restoreSuccess': 'Backup restored',
    'dictionary.restoreFile': 'File: {file}',
    'dictionary.restoreSummary': 'mode: {mode} / total: {total} / added: {added} / skipped: {skipped} / failed: {failed}',
    'dictionary.restoreLastRun': 'Executed at: {datetime}',
    'dictionary.restoreFailed': 'Failed to restore backup',
    'dictionary.import': 'Import Excel (.xlsx)',
    ...
    'dictionary.importFileName': '{name}',
    'dictionary.backupFetchFailed': 'Failed to fetch backup settings',
    'dictionary.backupUpdateFailed': 'Failed to update backup settings',
